...
function seedPlayers(db) {
  ...
  const players = [
    [
      ...
      'Сергей Сидоров',
      'Защитник',
      '/images/players/sergey-sidorov.png',
    ...
    [
      ...
      'Валерий Соколов',
      'Нападающий',
      '/images/players/valeriy-sokolov.png',
    ...
    [
      ...
      'Алексей Морозов',
      'Полузащитник',
      '/images/players/alexey-morozov.png',
    ...
    [
      ...
      'Михаил Орлов',
      'Нападающий',
      '/images/players/mikhail-orlov.png',
    ...
    [
      ...
      'Дмитрий Волков',
      'Защитник',
      '/images/players/dmitriy-volkov.png',
    ...
    [
      ...
      'Иван Петров',
      'Вратарь',
      '/images/players/ivan-petrov.png',
